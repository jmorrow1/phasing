...
public class Textfield2 extends Controller< Textfield2 > {
	...
	public Textfield2( ControlP5 theControlP5 , ControllerGroup< ? > theParent , String theName , String theDefaultValue , int theX , int theY , int theWidth , int theHeight ) {
	...
	@Override public Textfield2 setWidth( int theWidth ) {
		_myValueLabel.setWidth( theWidth );
		return super.setWidth( theWidth );
	}

	@Override public Textfield2 setHeight( int theHeight ) {
...
//	}
	...
	@Override public Textfield2 setValue( float theValue ) {
	...
	@Override public Textfield2 setSize( int theWidth , int theHeight ) {
