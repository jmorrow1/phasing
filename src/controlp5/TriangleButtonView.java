...
/**
 * 
 * Draws a ControlP5 Button as an isosceles triangle inscribed in an ellipse
 * (the ellipse isn't actually drawn). The ellipse's width and height are
 * defined by the width and height of the Button.
 * 
 * @author James Morrow
 *
 */
public class TriangleButtonView implements ControllerView<Button> {
     ...
     * 
     * @param headAngle
     *            The angle specifying where the triangle head is pointed, in
     *            radians.
     * @param deviationAngle
     *            How much the angles of the other two triangle vertices deviate
     *            from the triangle head, in radians.
     */
