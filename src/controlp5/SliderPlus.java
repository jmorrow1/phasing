...
/**
 * A subclass of ControlP5's Slider that overrides Slider's draw method in order
 * to draw text on top of and above the slider.
 * 
 * @author James Morrow
 *
 */
public class SliderPlus extends Slider {
     ...
     * @param captionFont
     *            The font used to draw the controller's name just above the
     *            slider
     * @param valueFont
     *            The font used to draw the controller's value on top of the
     *            slider
     * @param f
     *            A function from float to String, which is used to format the
     *            controller's value
     */
