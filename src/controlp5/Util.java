...
/**
 * Place to put simple useful static functions that operate on ControlP5
 * objects.
 * 
 * @author James Morrow
 *
...
public class Util {
     ...
     *            The Controller.
     * @param x1
     *            The new value for the Controller's leftmost x-coordinate.
     */
     ...
     *            The Controller.
     * @param x2
     *            The new value for the Controller's rightmost x-coordinate.
     */
     ...
     *            The Controller.
     * @param y2
     *            The new value for the Controller's lower y-coordinate.
     */
     ...
     *            The Controller.
     * @param y1
     *            The new value for the Controller's upper y-coordinate.
     */
