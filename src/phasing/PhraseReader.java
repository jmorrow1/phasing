 ...
 * the callback.
 * 
 * Should be able to cope and continue to read the phrase even while the phrase
 * changes state.
 * 
 * @author James Morrow
 *
...
public class PhraseReader {
     ...
     *            The phrase to read
     * @param id
     *            An integer identifying the phrase reader
     * @param callee
     *            The object on which to invoke the callback method
     * @param callback
     *            The callback method
     */
    ...
    /**
     * Reads some more of the phrase. How much is read is determined by the
     * dNotept argument. Calls the callback if it reads a new note.
     * 
     * @param dNotept
     *            The amount to read, in terms of musical time.
     */
     ...
     * method informs the PhraseReader of where to start reading again.
     * 
     * @param notept
     *            The place at which to start reading again.
     */
    ...
    public static interface PhraseReaderListener {
         ...
         * 
         * @param reader
         *            The PhraseReader sending the note events.
         */
