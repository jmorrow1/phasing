...
public class Scale implements JSONable {
    ...
    /**
     * Constructs a Scale from a JSONObject containing a name, an array of note
     * names, and an array of note values.
     * 
     * @param json
     *            The JSONObject
     * @param className
     *            The name of the class this scale belongs to ("Major", for
     *            instance).
     */
    ...
    /**
     * Constructs a Scale from a JSONObject containing a name, a class name, an
     * array of note names, and an array of note values.
     * 
     * @param json
     *            The JSONObject
     */
    ...
    /**
     * Gives the name of the note at the ith index, with 0 <= i && i <
     * this.size().
     * 
    ...
    /**
     * Gives the name for the given pitchValue that applies in the context of
     * this scale. The given pitchValue should be a pitch value within this
     * scale. If it isn't, the method returns "?".
     * 
     * Won't throw an array out of bounds exception.
     * 
     * @param pitchValue
     *            The MIDI value of the pitch.
     * @return The name of the note in the context of this scale, or "?" if the
     *         note doesn't exist in this scale.
     */
    ...
    /**
     * Gives the value of the note at the index i. if i > this.size(), that
     * value is extrapolated, so large values for i are perfectly acceptable.
     * 
    ...
    /**
     * Gives the index of the given note in the context of this scale. If the
     * given note does not exist in this scale, then the method will return -1.
     * If i > this.size(), the index is extrapolated, so large values for i are
     * perfectly acceptable. Same for small values for i, though this property
     * is less likely to be useful.
     * 
     * @param midiPitchValue
     *            The value of the note.
     * @return The index in this scale of the given note, or -1 if the given
     *         note does not exist in this scale.
     */
