...
/**
 * Represents a phrase with styling information that helps determine how to
 * depict the phrase as a picture.
 * 
 * @author James Morrow
 *
 */
public class PhrasePicture implements JSONable {
    ...
    private final Style drawStyle = pa -> {
        pa.noStroke();
        pa.fill(pa.getBlendedColor(blendAmt));
    };
    private final Style restStyle = pa -> {
    ...
    /**
     * Constructs a PhrasePicture for the given Phrase whose styling information
     * will be randomly generated. It will automatically be assigned a unique
     * name.
     * 
     * @param phrase
     *            The Phrase.
     * @param pa
     *            The source of randomness for initializing styling information.
     */
     ...
     *            The Phrase.
     * @param name
     *            The identifier of the PhrasePicture.
     * @param pa
     *            The source of randomness for initializing styling information.
     */
    ...
    /**
     * Copy constructor. Copies the given PhrasePicture's Phrase and styling
     * information but not its name.
     * 
     * @param phrasePicture
     *            The PhrasePicture to copy.
     */
     ...
     * 
     * @param json
     *            A JSONObject representing a PhrasePicture.
     */
     ...
     * 
     * @param noteStyleType
     *            The code that determines which functions are initialized.
     */
    private void initDrawNoteFuncs(int noteStyleType) {
        switch (noteStyleType) {
        case CIRCLE:
            drawNoteFunc = new DrawCircle(drawStyle);
            break;
        case DIAMOND:
            drawNoteFunc = new DrawDiamond(drawStyle);
            break;
        case SQUARE:
            drawNoteFunc = new DrawSquare(drawStyle);
            break;
        default:
            initDrawNoteFuncs(CIRCLE);
            break;
        }
    ...
    /**
     * 
     * @return The code (CIRCLE, DIAMOND, or SQUARE) that represents the type of
     *         draw note function this object uses.
     */
    private int noteStyleType() {
        if (drawNoteFunc instanceof DrawCircle)
            return CIRCLE;
        if (drawNoteFunc instanceof DrawDiamond)
            return DIAMOND;
        if (drawNoteFunc instanceof DrawSquare)
            return SQUARE;
        return 0;
    }
     ...
     * 
     * @param rect
     *            The area in which to draw the Phrase.
     * @param pa
     *            The PhasesPApplet to draw to and get color scheme information
     *            from.
     */
    ...
    /**
     * Iterates through the notes and rests in the phrase, performing the draw
     * note function on notes and the draw rest function on rests as it goes.
     * 
     * @param drawNote
     *            The function used to draw notes.
     * @param drawRest
     *            The function used to draw rests.
     * @param rect
     *            The area in which to draw the Phrase's notes.
     * @param pa
    ...
    /**
     * Changes a PhasesPApplet state in order to change the way it styles
     * graphics (such as changes in fill color, stroke color, etc.).
     * 
     * @author James Morrow
     *
     */
    ...
    /**
     * Draws a shape to a coordinate in space (x,y) with a radius r to a
     * PhasesPApplet pa.
     * 
     * @author James Morrow
     *
    ...
    /**
     * Takes an ArrayList of PhrasePictures and returns an array of the names of
     * the PhrasePictures.
     * 
