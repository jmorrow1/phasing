...
public class Rect extends Shape {
    ...
    /**
     * The rectMode argument behaves analogously to Processing's rectMode
     * method.
     * 
     * In other words, the following Java code... Rect r = new Rect(a, b, c, d,
     * rectMode); r.display(pa);
     * 
     * ...is behaviorally equivalent to the Processing code: rectMode(rectMode);
     * rect(a, b, c, d);
     * 
     * @param a
     * @param b
     ...
     * 
     * @param x
     *            The new center x-coordinate for this rectangle.
     * @param y
     *            The new center y-coordinate for this rectangle.
     */
     ...
     * 
     * @param x1
     *            the new leftmost x-coordinate for the rect
     */
     ...
     * 
     * @param y1
     *            the new uppermost y-coordinate for the rect
     */
