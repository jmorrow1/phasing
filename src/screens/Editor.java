...
public class Editor extends Screen implements PhraseReaderListener {
    ...
    // TODO Maybe find a naming convention that signals which of the following
    // methods
    // are to be used just as variables and which of them are to be used to
    ...
    /**
     * Gives the proper value for the uppermost y-coordinate of the bottom
     * tollbar, which is dependent on the height of the window.
     * 
    ...
    /**
     * Gives the proper value for the width of the hScrollbar, which is
     * dependent on the width of the grid.
     * 
     ...
     * 
     * @param gridFrame
     *            The grid frame which this controller is sized in relation to.
     * @return The proper width of the hScrollbar.
     */
    ...
    private static Rect consGridFrame(int screenWidth, int screenHeight) {
        float gridHeight = cellHeight
                * (int) ((botToolbarY1(screenHeight) - PhasesPApplet.topToolbarY2()) / cellHeight);
        return new Rect(10, PhasesPApplet.topToolbarY2(), screenWidth - 10, PhasesPApplet.topToolbarY2() + gridHeight,
                PApplet.CORNERS);
    }
    ...
    /**
     * Initalizes the ControlP5 object and controllers, in addition to adding
     * the controllers to the CP5 object.
     * 
    ...
    /**
     * Initializes the button that decreases phrase length note-by-note. Adds
     * the button to the CP5 object.
     * 
     * @param hScrollbar
     *            This is here to make explicit that this method relies on
     *            hScrollbar being already initialized.
     */
    ...
    /**
     * Constructs a sub-note button, associates it with the given ControlP5 and
     * returns it.
     * 
     * @param cp5
     *            The ControlP5 instance.
     * @param listener
     *            The object that should receive callbacks from the Button.
     * @param hScrollbar
     *            The horizontal scrollbar that this controllers is positioned
     *            in relation to.
     * @return The button.
     */
    private static Button consSubNoteButton(ControlP5 cp5, Object listener, Scrollbar hScrollbar) {
        ...
        Button b = cp5.addButton("decreasePhraseLength")
                ...
                .setSize(sideLength, sideLength).setView(new PlusMinusButtonView(false)).plugTo(listener);
    ...
    /**
     * Initializes the button that increases phrase length note-by-note. Adds
     * the button to the CP5 object.
     * 
     * @param hScrollbar
     *            This is here to make explicit that this method relies on
    ...
    /**
     * Constructs an add-note button, associates it with the given ControlP5 and
     * returns it.
     * 
     * @param cp5
     *            The ControlP5 instance.
    ...
    private static Button consAddNoteButton(ControlP5 cp5, Object listener, Scrollbar hScrollbar) {
        ...
        Button b = cp5.addButton("increasePhraseLength").setSize(sideLength, sideLength)
                .setPosition(Util.getX2(hScrollbar) + 10,
                        Util.getY2(hScrollbar) - hScrollbar.getHeight() / 2f - sideLength / 2f)
                .setView(new PlusMinusButtonView(true)).plugTo(listener);
    ...
    /**
     * Initializes the scrollbar that controls which sub-section of the phrase
     * is displayed. Adds the scrollbar to the CP5 object.
     * 
     * @param gridFrame
     *            The shape of the grid this controller is positioned in
     *            relation to.
     */
    private void initHorizontalScrollbar(Rect gridFrame) {
        hScrollbar = consHorizontalScrollbar(cp5, this, PApplet.min(rowSize(), pa.currentPhrase.getGridRowSize()),
                pa.currentPhrase.getGridRowSize(), pa.height, gridFrame);
    }
     ...
     *            The ControlP5 instance.
     * @param listener
     *            The object that should receive callbacks from the Scrollbar.
     * @param ticksPerScroller
     *            The number of ticks in the scroller (see Scrollbar
     *            documentation).
     * @param ticksPerTrack
     *            The number of ticks in the track (see Scrollbar
     *            documentation).
     * @param windowHeight
     *            The height of the window.
     * @param gridFrame
     ...
     */
    private static Scrollbar consHorizontalScrollbar(ControlP5 cp5, Object listener, int ticksPerScroller,
            int ticksPerTrack, int windowHeight, Rect gridFrame) {

        Scrollbar s = new Scrollbar(cp5, "hScrollbar", ticksPerScroller, ticksPerTrack);

        s.setPosition(gridFrame.getX1() + 40, windowHeight - 25f).setSize(hScrollbarWidth(gridFrame), 15)
                .plugTo(listener);
        colorController(s);
    ...
    /**
     * Initalizes the toggle that controls whether or not music plays. Adds the
     * toggle to the CP5 object.
     * 
     * @param bpmDifferenceSlider
     *            This is here to make explicit that this method relies on
     *            bpmDifferenceSlider being already initialized.
     */
    ...
    /**
     * Constructs and returns a play toggle that is connected with the given
     * ControlP5 instance.
     * 
     * @param bpmDifferenceSlider
     *            The slider that this controller is positioned in relation to.
     * @param cp5
     *            The ControlP5 instance.
     * @param listener
     *            The object that should receive callbacks from the Toggle.
     * @return The toggle.
     */
    private static Toggle consPlayToggle(Slider bpmDifferenceSlider, ControlP5 cp5, Object listener) {
        int sideLength = 35;
        Toggle t = cp5.addToggle("play").setSize(sideLength, sideLength)
                ...
                .plugTo(listener).setView(new ControllerView<Toggle>() {
                    @Override
    ...
    /**
     * Initializes the sliders that control the tempos (in beats per minute) of
     * the two players. Adds the sliders to the CP5 object.
     * 
     * @param scaleMenu
     *            This is here to make explicit that this method relies on
     *            scaleMenu being already initialized.
     */
    private void initBPMSliders(DropdownList scaleMenu) {
        ...
        bpmDifferenceSlider = consBPMDifferenceSlider(pa.width, pa.height, pa.getBPM2() - pa.getBPM1(), bpmSlider, cp5,
                this);
    }

    /**
     * Constructs the slider that controls the first player's tempo (in beats
     * per minute) at a given location and with a given size.
     * 
     * @param windowWidth
     *            The width of the window in which this slider will be
     *            displayed.
     * @param windowHeight
     *            THe height of the window in which this slider will be
     *            displayed.
     * @param value
     *            The initial bpm value.
     * @param scaleMenu
     *            The scale menu that this controller is positioned in relation
     *            to.
     * @param cp5
     *            The ControlP5 instance to attach the controller to.
     * @param listener
     *            The object that should recieve events from the controller.
     * @return The slider.
     */
    private static Slider consBPMSlider(int windowWidth, int windowHeight, float value, DropdownList scaleMenu,
            ControlP5 cp5, Object listener) {
        int sliderWidth = getSliderWidth(windowWidth);
        int sliderHeight = getSliderHeight();
        return consBPMSlider("beatsPerMinute", "Tempo 1", BPM_1, Util.getX2(scaleMenu) + PhasesPApplet.CONTROLLER_DX,
                PhasesPApplet.topToolbarY2() - margin_btwn_top_toolbar_y2_and_controllers - sliderHeight,
                (int) (1.1f * sliderWidth), sliderHeight, value, 11, 100, 1,
                (floatingPoint) -> "" + PApplet.round(floatingPoint), cp5, listener);
    }

    /**
     * Constructs the slider that controls the difference between the 1st
     * player's tempo and the 2nd player's tempo (in beats per minute) at a
     * given location and with a given size.
     * 
     * @param windowWidth
     *            The width of the window in which this slider will be
     *            displayed.
     ...
     * @param bpmSlider
     *            The bpm slider which this slider is defined in relation to.
     * @param cp5
     *            The ControlP5 instance to attach the controller to.
     * @param listener
     *            The object that should recieve events from the controller.
     * @return The slider.
     */
    private static Slider consBPMDifferenceSlider(int windowWidth, int windowHeight, float value, Slider bpmSlider,
            ControlP5 cp5, Object listener) {
        int sliderWidth = getSliderWidth(windowWidth);
        int sliderHeight = getSliderHeight();
        return consBPMSlider("bpmDifference", "Tempo Difference ", BPM_DIFFERENCE,
                ...
                PhasesPApplet.topToolbarY2() - margin_btwn_top_toolbar_y2_and_controllers - sliderHeight,
                (int) (0.9f * sliderWidth), sliderHeight, value, -MAX_DIFFERENCE, MAX_DIFFERENCE, 4,
                (floatingPoint) -> String.format("%.2f", floatingPoint), cp5, listener);
    }
     ...
     * @param label
     *            The String for the slider to display.
     * @param id
     *            An integer identification.
     * @param x
     *            The leftmost x-coordinate of the slider.
     * @param y
     *            The uppermost y-coordinate of the slider.
     * @param w
     *            The width of the slider.
     * @param h
     *            The height of the slider.
     * @param value
     *            The starting value the slider has.
     * @param minValue
     ...
     * @param f
     *            The function that converts floating points to Strings.
     * @param cp5
     *            The ControlP5 to attach the controller to.
     * @param listener
     *            The object that should receive events from the controller.
     * @return The slider.
     */
    private static Slider consBPMSlider(String name, String label, int id, float x, float y, int w, int h, float value,
            int minValue, int maxValue, int ticksPerWholeNumber, FloatFormatter f, ControlP5 cp5, Object listener) {
    ...
    /**
     * Initializes the drop-down menus that control what scale is active. Adds
     * the menus to the CP5 object.
     */
    ...
    /**
     * Constructs and returns a label-less, empty scale menu that is connected
     * with the given ControlP5 instance.
     * 
     * @param cp5
     *            The ControlP5 instance.
     * @param listener
     *            The object that should receive callbacks from the controller.
    ...
    private static DropdownListPlus consScaleMenu(ControlP5 cp5, Object listener) {
        ...
        d.setPosition(PhasesPApplet.getHelpButtonX2() + PhasesPApplet.CONTROLLER_DX,
                ...
                .setSize(130, menuItemHeight).setItemHeight(menuItemHeight).setBarHeight(menuItemHeight).close();
    ...
    /**
     * Constructs and returns a label-less, empty root menu that is connected
     * with the given ControlP5 instance.
     * 
     * @param cp5
     *            The ControlP5 instance.
    ...
    private static DropdownListPlus consRootMenu(ControlP5 cp5, Object listener) {
        ...
        d.setPosition(PhasesPApplet.getPresentButtonX2() + PhasesPApplet.CONTROLLER_DX,
                PhasesPApplet.topToolbarY2() - margin_btwn_top_toolbar_y2_and_controllers - menuItemHeight)
                .setSize(90, menuItemHeight).setItemHeight(menuItemHeight).setBarHeight(menuItemHeight).close();
    ...
    /**
     * Changes the style information of the given controller's label to reformat
     * it.
     * 
     * @param x
     *            The given controller, a DropdownList.
     */
    ...
    /**
     * Makes all the controllers that, according to the pa.playerInfo object,
     * the player has unlocked visible.
     */
    ...
    /**
     * Changes the way the given controller is colored. The way it does that is
     * based on the controller's subtype.
     * 
     * @param c
    ...
    /**
     * Manipulates the difference between the tempos (in beats per minute) of
     * the two players.
     * 
     * @param e
     */
    ...
    /**
     * Callback for ControlP5 When playStop controller is toggled
     * 
     * @param e
     */
    ...
    /**
     * 
     * @return True if user is simultaneously holding shift and pressing the
     *         left or right mouse button, false otherwise.
     */
    private boolean shiftClick() {
        return pa.keyPressed && shiftPressed && pa.mousePressed
                && (pa.mouseButton == pa.LEFT || pa.mouseButton == pa.RIGHT);
    }
    ...
    /**
     * Tries to write a pitch to the current phrase at some index. If it
     * succeeds, it also edits the note at the subsequent index when
     * appropriate.
     * 
     * @param index
     *            The index at which to add the pitch.
     * @param pitch
     *            The pitch.
     */
    ...
    /**
     * Tries to write a rest to the current phrase at some index. If it
     * succeeds, it also edits the note at the subsequent index when
     * appropriate.
     * 
     * @param index
     *            The index at which to add the rest.
     * @param pitch
     *            The pitch.
     */
    ...
    public void mouseReleased() {
        if ((cursorIsX && pa.mouseButton == pa.RIGHT) || (pa.mouseButton == pa.LEFT && shiftPressed)) {
            defaultCursor();
        }
        ...
        if (drawState == DRAWING_NOTE && mouseInGrid()) {
            ...
            if (newPitch == pitchMousePressed) {
                if (newIndex > indexMousePressed) {
                    ...
                    pa.currentPhrase.setCell(newIndex, pitchMousePressed, PhasesPApplet.defaultDynamic(),
                            Phrase.NOTE_SUSTAIN);
                } else if (newIndex < indexMousePressed && newIndex < startIndexOfUserDrawnNote) {
                    pa.currentPhrase.setCell(newIndex, pitchMousePressed, PhasesPApplet.defaultDynamic(),
                            Phrase.NOTE_START);
                    if (newIndex + 1 < pa.currentPhrase.getGridRowSize()) {
                        pa.currentPhrase.setCell(newIndex + 1, pitchMousePressed, PhasesPApplet.defaultDynamic(),
                                Phrase.NOTE_SUSTAIN);
                        indexMousePressed++;
                    }
            ...
            if (0 <= index && index < pa.currentPhrase.getGridRowSize()
                    && pitch == pa.currentPhrase.getGridPitch(index)) {
    ...
    /**
     * 
     * @return True, if the mouse intersects the grid (but not the piano-shaped
    ...
    private int mouseToIndex() {
        return (int) pa.map(pa.mouseX, gridFrame.getX1() + cellWidth, gridFrame.getX2(), 0, rowSize())
                + hScrollbar.getLowTick();
    }
    ...
    /**
     * Converts a y-value to a pitch value, using the coordinate system of the
     * grid.
     * 
     * @param y
     *            The y-value.
    ...
    /**
     * Converts a pitch value to a y-value, using the coordinate system of the
     * grid.
     * 
     * @param pitch
     *            The pitch value.
    ...
    private void drawCursor() {
        if (cursorIsX) {
            ...
            pa.line(pa.mouseX - component, pa.mouseY - component, pa.mouseX + component, pa.mouseY + component);
            pa.line(pa.mouseX - component, pa.mouseY + component, pa.mouseX + component, pa.mouseY - component);
        }
    }

    /**
     * Checks if any Editor-related thing should be unlocked, and performs the
     * unlocking for anything that should be unlocked.
     */
    ...
    /**
     * Checks if either the rootMenu or the scaleMenu have changed state. If
     * either has changed state, that means the current scale has changed, and
     * the editor needs to change state accordingly.
     */
    ...
    /**
     * Constructs a copy of the controller, one that looks just like the one
     * that appears in the Editor.
     * 
     * @param bpmDifferenceSlider
     *            The slider this controller is positioned in relation to.
     * @param cp5
     *            The ControlP5 instance.
     * @param listener
     *            The object that should receive callbacks from the controller.
     ...
     *            The object that should receive callbacks from the controller.
     * @param scaleMenu
     *            The scale menu that this controller is defined in relation to.
     * @param windowWidth
     *            The width of the window in which this controller will be
     *            drawn.
     * @param windowHeight
     *            The heigh of the window in which this controller will be
     *            drawn.
     * @return The controller.
     */
    public Slider copyBPMSlider(ControlP5 cp5, Object listener, DropdownListPlus scaleMenu, int windowWidth,
            int windowHeight) {
     ...
     *            The object that should receive callbacks from the controller.
     * @param bpmSlider
     *            The bpm slider that this controller is positioned in relation
     *            to.
     * @param windowWidth
     *            The width of the window in which this controller will be
     *            drawn.
     ...
     * @return The controller.
     */
    public Slider copyBPMDifferenceSlider(ControlP5 cp5, Object listener, Slider bpmSlider, int windowWidth,
            int windowHeight) {
     ...
     *            documentation).
     * @param screenHeight
     *            The height of the screen this controller is being defined in.
     * @param gridFrame
     *            The shape of the grid this controller is positioned in
     *            relation to.
     * @return The controller.
     */
    public Scrollbar copyHScrollbar(ControlP5 cp5, Object listener, int ticksPerScroller, int ticksPerTrack,
            int screenHeight, Rect gridFrame) {
     ...
     *            The object that should receive callbacks from the controller.
     * @param hScrollbar
     *            The scrollbar that this controller is positioned in relation
     *            to.
     * @return The controller.
     */
    ...
    /**
     * Constructs a copy of the shape of the grid, one that is just like the
     * shape of the Editor's grid.
     * 
     * @param windowWidth
     *            The width of the window in which the grid shape will be used.
     * @param windowHeight
     *            The height of the window in which the grid shape will be used.
