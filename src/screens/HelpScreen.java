...
public class HelpScreen extends Screen {
    ...
    private final static float mouseWidth = 40, mouseHeight = 80; // for an
                                                                  // 800x600
                                                                  // window
    ...
    private void drawInfo() {
        if (drawGridInfo) {
            ...
            pa.rectMode(pa.CORNERS);
            pa.fill(gridColor);
            pa.text(activeText, gridShape.getX1() + 15, gridShape.getY1() + 15, gridShape.getX2() - 15,
                    gridShape.getY2() - 15);
        }
    }
    ...
    private void showToDrawNotesMessage(float x1, float ceny) {
        ...
        drawMouse(x1 + mouseWidth / 2 + pa.textWidth("To draw notes:") + 21, ceny, mouseWidth, mouseHeight, true,
                false);
    }
    ...
    private void drawMouse(float cenx, float ceny, float width, float height, boolean fillLeftMouseButton,
            boolean fillRightMouseButton) {
