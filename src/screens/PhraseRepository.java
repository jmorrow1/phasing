...
public class PhraseRepository extends Screen implements CellEventHandler {
     ...
     * @param y1
     *            The topmost y-coordinate of the button.
     * @param size
     *            The width and height of the button.
     * @param angle
     *            The heading (where it's pointing) of the button, in terms of
     *            radians.
     * @return The newly constructed button.
     */
    private Button consDirectionalButton(String name, int x1, int y1, int size, float angle) {
        Button b = cp5.addButton(name).setPosition(x1, y1).setSize(size, size)
                .setView(new TriangleButtonView(angle, 0.7f * pa.PI)).plugTo(this);
    ...
    public void newPhrase() {
        int numCells = 12;
        pa.currentPhrase = new Phrase(pa.repeat(60f, numCells), pa.repeat(50f, numCells),
                pa.repeat(Phrase.REST, numCells), "Major", "C");
    ...
    /**
     * Removes a PhrasePicture from the list and sets whether the page buttons
     * are hidden or shown.
     * 
     * @param i
     */
    ...
    /**
     * Adds a PhrasePicture to the end of the list and sets whether the page
     * buttons are hidden or shown.
     * 
     * @param p
     *            The PhrasePicture
     */
    ...
    /**
     * Adds a PhrasePicture to the list and sets whether the page buttons are
     * hidden or shown.
     * 
     * @param i
     *            The index.
    ...
    public void mousePressed() {
        ...
        if (selectedCell != null) {
            ...
            // deal with previously selected cell (whose PhrasePicture may have
            // been renamed)
    ...
    /**
     * Sets the selectedCell's title based on the name of the
    ...
    /**
     * Gives the Cell that touches the given (x,y), or null if no such Cell
     * exists.
     * 
     * @param x
     * @param y
