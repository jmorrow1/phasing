...
/**
 * An InstrumentPlayer graphically animates an Instrument. It works by receiving
 * note events from a PhraseReader. To work properly, a PhraseReader needs to be
 * set up to send callbacks to the InstrumentPlayer.setActiveKey() method.
 * 
 * @author James Morrow
 *
 */
public class InstrumentPlayer {
     ...
     * 
     * @param instrument
     *            The instrument to animate.
     * @param phrase
     *            The phrase to animate it with.
     */
     ...
     * 
     * @param instrument
     *            The instrument for the InstrumentPlayer to play.
     */
