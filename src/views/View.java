...
public abstract class View extends Rect implements ViewVariableInfo {
     ...
     * 
     * @param viewBox
     *            The area in which the view is drawn.
     * @param opacity
     *            The opacity of things the view draws.
     * @param pa
     *            The PApplet the view draws to.
     */
    ...
    /**
     * After a period of neglect (in which update has not been invoked), this
     * method informs the view of the state of the phasing process, so the view
     * can get in sync with it. This comes down to telling the view what part of
     * the phrase player 1 is reading and what part of the phrase player 2 is
     * reading.
     * 
     * @param notept1
     *            The part of the phrase player 1 is currently reading.
     * @param notept2
     *            The part of the phrase player 2 is currently reading.
     */
    ...
    /**
     * Allows the view to change its state in response to a change in one of its
     * option variables.
     */
    ...
    /**
     * Handles the event of this view being resized. This method is called AFTER
     * the view has been resized.
     * 
     * @param prevWidth
     *            The width of the View before the resizing occured.
     * @param prevHeight
     *            The height of the View before the resizing occured.
     */
    ...
    /**
     * Saves the option's value to the given playerInfo object under the given
     * name.
     * 
     * @param var
     *            The option.
    ...
    /**
     * Changes the settings of the view to values given by the playerInfo
     * object.
     * 
     * @param playerInfo
     */
     ...
     * If the playerInfo object doesn't contain the desired value, then nothing
     * happens.
     * 
     * @param var
     *            The ModInt.
     * @param key
     *            The name of the value, used to look up the value in the
     *            playerInfo object.
     * @param playerInfo
     *            The playerInfo object.
     */
     ...
     * 
     * @param phraseReader
     *            The PhraseReader that is sending the event.
     */
